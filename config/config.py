...
class Config:
    ...
    #
    # Разделители при чтении/записи значений из столбца:
    #   wildberries: ";"   — несколько ссылок через точку с запятой
    #   ozon:        " "   — несколько ссылок через пробел
    #   yandex:      ","   — несколько ссылок через запятую
    # ===================================================================
    ...
    # Разделители фото-ссылок при чтении из столбца МП
    ...
    # Разделители фото-ссылок при записи в столбец МП
