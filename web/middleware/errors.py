...
def _is_json_request(request: Request) -> bool:
    ...
    Критерии:
        ...
        - URL начинается с /v1/ — внешний REST API агента маппинга
          PIM+FDM: все ответы обязаны быть JSON по спецификации,
          HTML-страница ошибки недопустима для API-клиента
...
_ERROR_MESSAGES = {
    ...
    422: ("Ошибка валидации данных", "Переданные данные не соответствуют требованиям. Проверьте структуру запроса."),
